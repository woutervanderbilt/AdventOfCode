...
{
    public struct ContinuedFractionBigInt
    {
        public ContinuedFractionBigInt(IList<long> values, int? repeatIndex = null)
        {
            Values = values;
        ...
        public RationalBigInteger ComputeFraction(int depth)
        {
        ...
        public static ContinuedFractionBigInt ContinuedFractionOfSquareRoot(long s)
        {

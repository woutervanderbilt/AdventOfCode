...
public class Dag19 : Problem
{
    ...
    public override Task ExecuteAsync()
    {
        ...
        long FindMinimumY(long start)
        {
            while (true)
            {
                computer.Reset().AddParameters(x, start);
                if (computer.Run().First() == 1)
                {
                    break;
                }
    ...
    public override int Nummer => 201919;
}